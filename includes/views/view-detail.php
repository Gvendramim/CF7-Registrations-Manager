		...
		<div class="mcr-detail-main">
			<form method="post">
				...
				<table class="form-table mcr-detail-table" role="presentation">
					<tbody>
						<tr>
							<th scope="row"><?php esc_html_e( 'Child Name', 'music-club-registrations' ); ?></th>
							<td><?php echo esc_html( $registration['child_name'] ); ?></td>
						</tr>
						<tr>
							<th scope="row"><?php esc_html_e( 'Parent Name', 'music-club-registrations' ); ?></th>
							<td><?php echo esc_html( $registration['parent_name'] ); ?></td>
						</tr>
						<tr>
							<th scope="row"><?php esc_html_e( 'Parent Email', 'music-club-registrations' ); ?></th>
							<td><a href="mailto:<?php echo esc_attr( $registration['parent_email'] ); ?>"><?php echo esc_html( $registration['parent_email'] ); ?></a></td>
						</tr>
						<tr>
							<th scope="row"><?php esc_html_e( 'Phone', 'music-club-registrations' ); ?></th>
						...
						<tr>
							<th scope="row"><?php esc_html_e( 'Interests', 'music-club-registrations' ); ?></th>
							<td>
								<?php echo $interests ? esc_html( implode( ', ', $interests ) ) : '&mdash;'; ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th scope="row"><?php esc_html_e( 'Submitted On', 'music-club-registrations' ); ?></th>
							<td>
								<?php
								echo esc_html(
